# Immortal Portals - Thunderstore 发布打包脚本
#
# 用法：powershell -ExecutionPolicy Bypass -File .\package.ps1
#
# 产物：dist\ImmortalPortals-<版本>.zip
...
#     LICENSE.txt
#     icon.png
#     BepInEx/plugins/ImmortalPortals/ImmortalPortals.dll
...
$projectFile = Join-Path $projectDir "ImmortalPortals.csproj"
...
Copy-Item (Join-Path $projectDir "README.md") $stagingDir

# 插件文件
$pluginTarget = Join-Path $stagingDir "BepInEx\plugins\ImmortalPortals"
New-Item -ItemType Directory -Path $pluginTarget -Force | Out-Null
Copy-Item (Join-Path $projectDir "obj\$Configuration\ImmortalPortals.dll") $pluginTarget
